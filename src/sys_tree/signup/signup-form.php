    ...
    <div class="formBox">
      ...
      <form class="signup-form needs-validation" id="signup-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <div class="row row-cols-sm-1">
          <div class="section-header">
            <h4 class="h4"><?php echo lang("COMPANY INFO", $lang_file) ?></h4>
          </div>
            ...
            <div class="form-floating">
              ...
              <select class="form-select" name="country" id="country" required>
                <?php if ($countries_count > 0) { ?>
                  <option value="default" disabled selected><?php echo lang('SELECT COUNTRY', $lang_file) ?></option>
                  <?php foreach ($countries_data as $country) { ?>
                    <option value="<?php echo $country['country_id'] ?>"><?php echo @$_SESSION['sys']['lang'] == 'ar' ? $country['country_name_ar'] : $country['country_name_en'] ?></option>
                  <?php } ?>
                <?php } ?>
              </select>
              <label for="country"><?php echo lang("COUNTRY", $lang_file) ?></label>
            </div>
            <!-- address -->
            <div class="form-floating">
            ...
            <div class="col">
              ...
              <div class="mb-3 form-floating">
                <select class="form-select" name="gender" id="gender" required>
                  <option value="default" disabled selected><?php echo lang("SELECT GENDER", $lang_file) ?></option>
                  <option value="0"><?php echo lang("MALE", $lang_file) ?></option>
                  <option value="1"><?php echo lang("FEMALE", $lang_file) ?></option>
                </select>
      ...
      <div>
        <p>
          ...
          <a href="../../index.php"><?php echo lang('FROM HERE', $lang_file) ?>&nbsp;<i class="bi bi-arrow-up-left-square"></i></a>
        </p>
      </div>
    </div>
  </div>
