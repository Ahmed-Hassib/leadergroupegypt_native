                ...
                <div class="section-block">
                    ...
                    if ($rowsCount > 0) { 
                        ...
                        if ($licenseDate >= $today) { 
                            switch($row['type']) {
                                case 0:
                                    $type = lang('FOREVER', @$_SESSION['sys']['lang']);
                                    break;
                                case 1:
                                    $type = lang('MONTHLY', @$_SESSION['sys']['lang']);
                                    break;
                                case 2:
                                    $type = lang('3 MONTHS', @$_SESSION['sys']['lang']);
                                    break;
                                case 3:
                                    $type = lang('6 MONTHS', @$_SESSION['sys']['lang']);
                                    break;
                                case 4:
                                    $type = lang('YEARLY', @$_SESSION['sys']['lang']);
                                    break;
                                default:
                                    $type = lang('TRIAL', @$_SESSION['sys']['lang']);
                            }
                        ?>
                            <p>
