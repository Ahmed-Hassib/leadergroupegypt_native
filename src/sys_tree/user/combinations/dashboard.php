  ...
  <div class="stats">
    ...
    <div class="mb-3 row row-cols-sm-1 row-cols-md-2 g-3 align-items-stretch justify-content-start">
      ...
      <div class="col-12">
        <div class="section-block">
          <header class="section-header">
            <h5 class="h5 text-capitalize"><?php echo lang('COMBS TODAY', $lang_file) ?></h5>
      ...
      <div class="col-12">
        <div class="section-block">
          <header class="section-header">
            <h5 class="h5 text-capitalize"><?php echo lang('COMBS MONTH', $lang_file) ?></h5>
      ...
      <div class="col-12">
        <div class="section-block">
          <header class="section-header">
            <h5 class="h5 text-capitalize"><?php echo lang('COMBS PREV MONTH', $lang_file) ?></h5>
      ...
      <div class="col-12">
        <div class="section-block">
          <header class="section-header">
            <h5 class="h5 text-capitalize"><?php echo lang('TOTAL COMBS', $lang_file) ?></h5>
            <p class="text-muted "><?php echo lang('TOTAL COMBS NOTE', $lang_file) ?></p>
            <hr>
          </header>
          <div class="row row-cols-sm-2 gx-3 gy-5">
            <div class="col-6">
    ...
    <?php if ($all_comb > 0) { ?>
      <div class="mb-3 row row-cols-sm-1 align-items-center justify-content-center">
        ...
        <div class="col-12">
          <div class="section-block">
            <header class="section-header">
              <h5 class="h5 text-capitalize"><?php echo lang("COMBS RATING", $lang_file) ?></h5>
              <p class="text-muted "><?php echo lang("COMBS RATING NOTE", $lang_file) ?></p>
              <hr>
            </header>
      ...
      <div class="mb-3 row row-cols-sm-1 align-items-center-justify-content-center">
        <div class="col-12">
          <div class="section-block">
            <header class="section-header">
              <h5 class="h5 text-capitalize"><?php echo lang('COMBS TODAY', $lang_file) ?></h5>
              <p class="text-muted "><?php echo lang('SOME COMBS NOTE', $lang_file) ?></p>
              <hr>
            </header>
            <?php
              ...
              <table class="table table-striped no-index table-bordered  display compact w-100">
                <thead class="primary text-capitalize">
                  <tr>
                    ...
                    <th class="text-center"><?php echo lang('ADDR', $lang_file) ?></th>
                    <th class="text-center"><?php echo lang('PHONE', $lang_file) ?></th>
                    <th class="text-center"><?php echo lang('TECH NAME', $lang_file) ?></th>
                    <th class="text-center"><?php echo lang('STATUS', $lang_file) ?></th>
                    <th class="text-center"><?php echo lang('MEDIA', $lang_file) ?></th>
                  ...
                  <?php foreach ($today_comb as $index => $comb) { ?>
                    <tr class="text-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
                      ...
                      <td style="width: 100px">
                        ...
                        <a href="<?php echo $nav_up_level ?>users/index.php?do=edit-user-info&userid=<?php echo base64_encode($comb['UserID']); ?>"><?php echo $techName ?></a>
                      </td>
                      ...
                      <td style="width: 50px">
                        <?php if ($_SESSION['sys']['comb_show'] == 1 || $_SESSION['sys']['comb_delete'] == 1) { ?>
                          <?php if ($_SESSION['sys']['comb_show'] == 1) { ?>
                            <a href="?do=edit-combination&combid=<?php echo base64_encode($comb['comb_id']) ?>" target="" class="btn btn-outline-primary me-1 fs-12"><i class="bi bi-eye"></i></a>
                          <?php } ?>
                          <?php if ($_SESSION['sys']['comb_delete'] == 1) { ?>
                            <button type="button" class="btn btn-outline-danger text-capitalize form-control bg-gradient fs-12" data-bs-toggle="modal" data-bs-target="#deleteCombModal" id="delete-comb" data-comb-id="<?php echo base64_encode($comb['comb_id']) ?>" onclick="put_comb_data_into_modal(this, true)"><i class="bi bi-trash"></i></button>
                          <?php } ?>
                        <?php } ?>
                      </td>
                    </tr>
    ...
    ?>
      <div class="mb-3 row row-cols-sm-1 align-items-center-justify-content-center">
        ...
        <div class="col-12">
          <div class="section-block">
            <header class="section-header">
              <h5 class="h5 text-capitalize"><?php echo lang('LATEST COMBS', $lang_file) ?></h5>
              <p class="text-muted "><?php echo lang("LATEST COMBS NOTE", $lang_file) ?></p>
              <hr>
            </header>
            <div class="table-responsive-sm">
