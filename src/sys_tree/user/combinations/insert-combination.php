...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($_SESSION['sys']['isLicenseExpired'] == 0) {
    ...
    if (empty($formErorr)) {
      ...
      array_push($comb_info, $client_name, $client_phone, $client_addr, $client_coordinates, get_date_now(), get_time_now(), $client_notes, $tech_id, $admin_id, base64_decode($_SESSION['sys']['company_id']));
