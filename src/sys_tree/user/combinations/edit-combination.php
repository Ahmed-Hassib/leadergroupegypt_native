          ...
          <?php if ($_SESSION['sys']['comb_update'] == 1) { ?>
            ...
            <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
              <textarea type="text" name="client-notes" id="client-notes" class="form-control w-100"
                style="resize: none; height: 120px;" placeholder="<?php echo lang('NOTE') ?>"
                style="resize: none; direction: <?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'rtl' : 'ltr' ?>" <?php echo $comb_info['isFinished'] == 1 ? 'disabled' : '' ?> required><?php echo $comb_info['comment'] ?></textarea>
        ...
        <div class="combination-info-container__row section-block">
          ...
          <div class="date-time-content">
            ...
            <div class="date-time-content__row">
              ...
              <div class="position-relative">
                <span class="text-primary" dir='ltr'>
                  <?php echo date_format(date_create($comb_info['added_date']), 'd/m/Y') ?>
                </span>
              </div>
            </div>
            <!-- added time -->
            <div class="date-time-content__row">
              ...
              <div class="position-relative">
                <span class="text-primary" dir='ltr'>
                  <?php echo date_format(date_create($comb_info['added_time']), 'h:i:s a') ?>
                </span>
              </div>
            </div>
            <!-- showed date -->
            <div class="date-time-content__row">
              ...
              <div class="position-relative">
                <?php if ($comb_info['isShowed']) { ?>
                  <span class="text-primary" dir='ltr'>
                    <?php echo date_format(date_create($comb_info['showed_date']), 'd/m/Y') ?>
                  </span>
                <?php } else { ?>
            ...
            <div class="date-time-content__row">
              ...
              <div class="position-relative">
                <?php if ($comb_info['isShowed']) { ?>
                  <span class="text-primary" dir='ltr'>
                    <?php echo date_format(date_create($comb_info['showed_time']), 'h:i:s a') ?>
                  </span>
                <?php } else { ?>
                  <span class="text-danger fw-bold">
                    <?php echo lang('NOT SHOWED', $lang_file) ?>
            ...
            <div class="date-time-content__row">
              ...
              <div class="position-relative">
                <?php if ($comb_info['isFinished']) { ?>
                  <span class="text-primary" dir='ltr'>
                    <?php echo date_format(date_create($comb_info['finished_date']), 'd/m/Y') ?>
                  </span>
                <?php } else { ?>
                  <span class="text-danger fw-bold">
            ...
            <div class="date-time-content__row">
              ...
              <div class="position-relative">
                <?php if ($comb_info['isFinished'] == 1) { ?>
                  <span class="text-primary" dir='ltr'>
                    <?php echo date_format(date_create($comb_info['finished_time']), 'h:i:s a') ?>
                  </span>
                <?php } else { ?>
                  <span class="text-danger fw-bold">
                    <?php echo lang('NOT ASSIGNED') ?>
