  ...
  <div class="section-header">
    ...
    <form action="?do=change-mikrotik-status" method="post">
      ...
      <div class="service-status form-check form-switch">
        <input class="form-check-input" type="checkbox" role="switch" id="mikrotikStatusSwitch"
          <?php echo $_SESSION['sys']['mikrotik']['status'] == true ? 'checked' : '' ?>>
      </div>
    </form>
  </div>
    ...
    <form action="?do=change-mikrotik" method="POST" id="mikrotik-settings">
      <div class="ip-port-container">
        ...
        <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
          <input class="form-control" type="text" name="mikrotik-ip" id="mikrotik-ip"
            ...
            placeholder="<?php echo lang('IP') ?>" <?php echo $_SESSION['sys']['mikrotik']['status'] == true ? '' : 'disabled' ?>>
        ...
        <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
          <input class="form-control" type="number" name="mikrotik-port" id="mikrotik-port"
            ...
            placeholder="<?php echo lang('PORT') ?>" <?php echo $_SESSION['sys']['mikrotik']['status'] == true ? '' : 'disabled' ?>>
      ...
      <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
        <input class="form-control" type="text" name="mikrotik-username" id="mikrotik-username"
          ...
          placeholder="<?php echo lang('USERNAME') ?>" <?php echo $_SESSION['sys']['mikrotik']['status'] == true ? '' : 'disabled' ?>>
      ...
      <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
        <input class="form-control" type="password" name="mikrotik-password" id="mikrotik-password"
          ...
          placeholder="<?php echo lang('PASSWORD') ?>" <?php echo $_SESSION['sys']['mikrotik']['status'] == true ? '' : 'disabled' ?>>
      ...
      <div class="hstack gap-3 justify-content-end">
        <?php if (isset($_SESSION['sys']['mikrotik']) && !empty($_SESSION['sys']['mikrotik']['ip']) && !empty($_SESSION['sys']['mikrotik']['username']) && !empty($_SESSION['sys']['mikrotik']['password'])) { ?>
          ...
          <button type="button" form="mikrotik-settings"
            ...
            data-bs-target="#mikrotikCheckInfoModal" <?php echo $_SESSION['sys']['mikrotik']['status'] == true ? '' : 'disabled' ?>>
