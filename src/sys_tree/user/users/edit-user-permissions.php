...
<div class="mb-4 row">
  ...
  <div class="col-sm-12 col-md-8">
    <div class="row row-cols-sm-1 row-cols-md-3 row-cols-lg-5 align-items-start g-sm-1 gx-md-5">
      <div class="col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" <?php if ($_SESSION['user_update'] == 0 || $_SESSION['permission_update'] == 0) {echo 'disabled';} ?> <?php if ($permissions['clients_add'] == 1) {echo 'checked';} ?> value="1" name="clientsAdd" id="clientsPage1">
      ...
      <div class="col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" <?php if ($_SESSION['user_update'] == 0 || $_SESSION['permission_update'] == 0) {echo 'disabled';} ?> <?php if ($permissions['clients_update'] == 1) {echo 'checked';} ?> value="1" name="clientsUpdate" id="clientsPage2">
      ...
      <div class="col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" <?php if ($_SESSION['user_update'] == 0 || $_SESSION['permission_update'] == 0) {echo 'disabled';} ?> <?php if ($permissions['clients_delete'] == 1) {echo 'checked';} ?> value="1" name="clientsDelete" id="clientsPage3">
      ...
      <div class="col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" <?php if ($_SESSION['user_update'] == 0 || $_SESSION['permission_update'] == 0) {echo 'disabled';} ?> <?php if ($permissions['clients_show'] == 1) {echo 'checked';} ?> value="1" name="clientsShow" id="clientsPage4">
...
<div class="mb-4 row">
  ...
  <div class="col-sm-12 col-md-8">
    ...
    <div class="row row-cols-sm-1 row-cols-md-3 align-items-start g-sm-1 gx-md-5">
      <div class="col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" <?php if ($_SESSION['user_update'] == 0 || $_SESSION['permission_update'] == 0) {echo 'disabled';} ?> <?php if ($permissions['comb_media_delete'] == 1) {echo 'checked';} ?> value="1" name="combMediaDelete" id="combMediaDelete">
      ...
      <div class="col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" <?php if ($_SESSION['user_update'] == 0 || $_SESSION['permission_update'] == 0) {echo 'disabled';} ?> <?php if ($permissions['comb_media_download'] == 1) {echo 'checked';} ?> value="1" name="combMediaDownload" id="combMediaDownload">
