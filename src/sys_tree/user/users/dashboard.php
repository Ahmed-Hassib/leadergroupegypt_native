<?php $user_obj = !isset($user_obj) ? new User() : $user_obj; ?>
<?php
// check system theme
...
<div class="container" dir="<?php echo $page_dir ?>">
  ...
  <div class="mb-3">
    ...
    if (empty($users_info) || $users_counter == 0) { ?>
      <h5 class='h5 text-center text-danger '><?php echo lang('NO EMPLOYEES', $lang_file) ?></h5>
    <?php } else { ?>
      ...
      <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-4 g-4 align-items-stretch justify-content-start">
        <?php foreach ($users_info as $index => $user) { ?>
          <div class="col-12">
            <div class="card <?php echo isset($card_class) ? $card_class : ''; ?> <?php echo isset($card_position) ? $card_position : ''; ?>">
              <div class="edit-icon">
                ...
                <div class="vstack gap-1">
                  ...
                  <h5 class="mb-0 card-title">
                    ...
                    <?php if ($user['joinedDate'] == get_date_now()) { ?>
                      <span class="badge bg-danger"><?php echo lang('NEW') ?></span>
                    <?php } ?>
                  </h5>
                  <!-- job title -->
                ...
                <div class="row g-1 align-items-center">
                  <div class="col-sm-12 col-lg-4">
                    <p class="col-12 card-text text-secondary mb-0 fs-12 fs-10-sm">
                      <?php echo lang('JOINED') ?><br><?php echo $user['joinedDate'] ?>
                    </p>
                  </div>
