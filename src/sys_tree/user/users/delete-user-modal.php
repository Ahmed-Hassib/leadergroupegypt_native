  ...
  <div class="modal-dialog modal-dialog-centered" style="width: 500px"  dir="<?php echo $page_dir ?>">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4 class="h4" <?php echo @$_SESSION['sys']['lang'] == "ar" ? "dir=rtl" : ""; ?>><?php echo lang('CONFIRM DELETE')." '" ?> <span id="deleted-username" class="text-danger"></span> <?php echo "' ".( @$_SESSION['sys']['lang'] == "ar" ? "؟" : "?" )?> </h4>
      </div>
      <div class="modal-footer">
        <?php if ($_SESSION['sys']['user_delete'] == 1) { ?>
          <a id="delete-user" class="btn btn-danger text-capitalize py-1 fs-12" dir="<?php echo $page_dir ?>"><i class="bi bi-trash"></i>&nbsp;<?php echo lang('DELETE') ?></a>
        <?php } ?>
