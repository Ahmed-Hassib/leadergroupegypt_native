    ...
    <div class="mb-3 row row-cols-sm-1 row-cols-md-2 g-3 align-items-stretch justify-content-start">
      ...
      <div class="col-12">
        <div class="section-block">
          <div class="section-header">
            <h5><?php echo lang('PCS INFO', $lang_file); ?>
            </h5>
            <hr />
          </div>
          <!-- full name -->
          ...
          <div class="mb-3 row">
            ...
            <div class="mt-2 col-sm-12 col-md-8">
              ...
              <div class="form-check form-check-inline">
                ...
                <label class="form-check-label text-capitalize" for="piece"><?php echo lang('TRANSMITTER', $lang_file) ?></label>
              </div>
              <!-- RECEIVER -->
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="is-client" id="client" value="2">
                <label class="form-check-label text-capitalize" for="client"><?php echo lang('RECEIVER', $lang_file) ?></label>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-12">
        <div class="section-block">
          ...
          <div class="mb-3">
            <div class="form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
              <input type="text" name="internet-source" id="internet-source" class="form-control w-100" placeholder="<?php echo lang('INT SRC', $lang_file) ?>" />
          ...
          <div class="mb-3">
            <div class="form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
              ...
              <label for="notes" class="col-sm-12 col-form-label text-capitalize"><?php echo lang('NOTE') ?></label>
            </div>
          </div>
          <!-- visit time -->
          <div class="mb-3 row">
