...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($form_error)) {
    ...
    $is_inserted = $pcs_obj->insert_new_piece(array($full_name, $ip, $port, $username, $password, $conn_type, $dir_id, $source_id, $alt_source_id, $is_client, $device_type, $device_id, $model_id, base64_decode($_SESSION['sys']['UserID']), $date_now, base64_decode($_SESSION['sys']['company_id']), $notes, $visit_time));
