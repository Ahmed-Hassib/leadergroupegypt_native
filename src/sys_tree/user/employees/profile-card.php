    ...
    <div class="col-12">
      <div class="section-block">
            ...
            <div class="p-2">
              ...
              <div class="row g-3 justify-content-start align-items-baseline">
                ...
                <div class="col-sm-12 col-md-4">
                  ...
                  <span class="<?php echo $user['joined_at'] == '0000-00-00' ? ' text-danger' : 'text-black' ?>"><?php echo $user['joined_at'] != '0000-00-00' ? $user['joined_at'] : lang('NO DATA') ?></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="hstack gap-2">
          ...
          <?php if ($user['trust_status'] != 1 && $user['job_title_id'] != 1 && $_SESSION['sys']['user_delete'] == 1 && $_SESSION['sys']['isLicenseExpired'] == 0) { ?>
