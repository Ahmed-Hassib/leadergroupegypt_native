  ...
  if ($counter > 0) {
    ...
    <div class="container" dir="<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'rtl' : 'ltr' ?>">
      ...
      <div class="row row-cols-sm-1 row-cols-lg-2 g-3">
        ...
        <form class="profile-form" action="?do=update-user-info" method="POST" enctype="multipart/form-data"
          id="edit-user-info" onchange="form_validation(this)">
          <!-- strat submit -->
          <div class="hstack gap-3">
            <div class="<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>">
              <!-- edit button -->
              <?php if (($_SESSION['sys']['user_update'] == 1 || $user['UserID'] == base64_decode($_SESSION['sys']['UserID'])) && $_SESSION['sys']['isLicenseExpired'] == 0) { ?>
                <button type="button" form="edit-user-info"
                  dir="<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'ltr' : 'rtl' ?>"
                  class="btn btn-primary text-capitalize py-1 fs-12" onclick="form_validation(this.form, 'submit')"><i
                    class="bi bi-check-all"></i>&nbsp;
                  <?php echo lang('SAVE') ?>
                </button>
              <?php } ?>

              <?php if ($user['is_root'] != 1 && $user['trust_status'] != 1 && $user['job_title_id'] != 1 && $_SESSION['sys']['user_delete'] == 1 && $user['UserID'] != base64_decode($_SESSION['sys']['UserID']) && $_SESSION['sys']['isLicenseExpired'] == 0) { ?>
                <!-- delete button -->
                <button type="button" data-bs-toggle="modal" data-bs-target="#deleteUserModal"
                  onclick="show_delete_user_modal(this)" data-username="<?php echo $user['username'] ?>"
                  data-user-id="<?php echo $user['UserID'] ?>"
                  dir="<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'ltr' : 'rtl' ?>"
                  class="btn btn-outline-danger text-capitalize py-1 fs-12"><i class="bi bi-trash"></i>&nbsp;
            ...
            <div class="col-sm-12">
              <div class="section-block">
                ...
                <div class="mb-3 row profile-image-container" id="profile-image-container">
                  ...
                  <img loading="lazy" src="<?php echo "$profile_img_path/$profile_img_name" ?>" class="profile-img" alt=""
                    id="profile-img">
                  <!-- profile image form -->
                  <input type="file" class="d-none" name="profile-img-input" id="profile-img-input"
                    onchange="change_profile_img(this)" accept="image/*">
                </div>
                <!-- end profile image -->
                <?php if (base64_decode($_SESSION['sys']['UserID']) == $user['UserID']) { ?>
                  ...
                  <div class="vstack gap-3 justify-content-center">
                    ...
                    <div class="mx-auto">
                      <!-- edit image button -->
                      <button type="button" role="button" class="btn btn-outline-primary fs-12 py-1 text-capitalize"
                        onclick="click_input()">
              ...
              <div class="section-block">
                ...
                <div class="mb-3">
                  <div
                    ...
                    <input type="text" class="form-control" name="fullname" id="fullname"
                      placeholder="<?php echo lang('FULLNAME', $lang_file) ?>" value="<?php echo $user['fullname'] ?>" <?php echo $_SESSION['sys']['user_update'] == 0 && base64_decode($_SESSION['sys']['UserID']) != $user['UserID'] ? 'readonly' : '' ?> required>
                    <label for="fullname">
                ...
                <div
                  ...
                  <input type="text" class="form-control" name="address" id="address" aria-describedby="address"
                    value="<?php echo $user['address'] ?>" placeholder="<?php echo lang('NO DATA') ?>" <?php echo $_SESSION['sys']['user_update'] == 0 && base64_decode($_SESSION['sys']['UserID']) != $user['UserID'] ? 'readonly' : '' ?>>
                  <label for="address">
                ...
                <!-- strat phone field -->
                <div class="mb-3">
                  <div class="phone-container" <?php if ((empty($user['phone']) || $_SESSION['sys']['isLicenseExpired'] == 1) && 1) { ?>style="grid-template-columns: 1fr!important" <?php } ?>>
                    <div
                      class="form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
                    ...
                    <?php if ($user['is_activated_phone'] == 0 && !empty($user['phone']) && $_SESSION['sys']['isLicenseExpired'] == 0 && 0) { ?>
                ...
                <div
                  ...
                  <input type="date" class="form-control px-5" name="date-of-birth" id="date-of-birth"
                    value="<?php echo $user['date_of_birth'] ?>" <?php echo $_SESSION['sys']['user_update'] == 0 && base64_decode($_SESSION['sys']['UserID']) != $user['UserID'] ? 'readonly' : '' ?>>
              ...
              <div class="section-block">
                ...
                <div
                  ...
                  <input type="email" class="form-control" name="email" id="email" placeholder="example@example.com"
                    aria-describedby="emailHelp" value="<?php echo $user['email'] ?>" <?php echo $_SESSION['sys']['user_update'] == 0 && base64_decode($_SESSION['sys']['UserID']) != $user['UserID'] ? 'readonly' : '' ?>>
                  <label for="email">
                ...
                <div class="mb-3 position-relative">
                  <div
                    ...
                    <input type="text" class="form-control" name="username" id="username"
                      placeholder="<?php echo lang('USERNAME LOGIN', $lang_file) ?>" autocomplete="off"
                      value="<?php echo $user['username'] ?>" required readonly>
                    <label for="username">
                ...
                <div class="mb-3 position-relative">
                  <div
                    class="form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
                    <input type="hidden" name="old-password" value="<?php echo $user['password'] ?>">
                    <input type="password" class="form-control" name="password" id="password"
                      placeholder="<?php echo lang('ENTER NEW PASSSWORD', $lang_file) ?>" aria-describedby="passHelp"
                      autocomplete="new-password" <?php echo $_SESSION['sys']['user_update'] == 0 && base64_decode($_SESSION['sys']['UserID']) != $user['UserID'] ? 'readonly' : '' ?>>
                    <i class="bi bi-eye-slash show-pass <?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'show-pass-left' : 'show-pass-right' ?>"
                      id="show-pass" onclick="show_pass(this)"></i>
                    <label for="password">
                ...
                <div class="mb-3 position-relative">
                  <div
                    ...
                    <select class="form-select" name="job_title_id" id="job_title_id" <?php echo $_SESSION['sys']['user_update'] == 0 ? 'disabled' : '' ?> required>
                      ...
                      <option value="default" <?php echo $user['job_title_id'] == 0 ? 'selected' : '' ?> disabled>
                        <?php echo lang('JOB TITLE', $lang_file) ?>
                      </option>
                      <?php foreach ($job_titles as $job_title) { ?>
                        <option value="<?php echo base64_encode($job_title['job_title_id']) ?>" <?php echo $user['job_title_id'] == $job_title['job_title_id'] ? 'selected' : '' ?>>
              ...
              <div class="section-block">
                ...
                <div class="input-group mb-3">
                  ...
                  <div
                    ...
                    <input type="text"
                      ...
                      name="twitter" value="<?php echo $user['twitter'] ?>" placeholder="<?php echo lang('NO DATA') ?>"
                ...
                <div class="input-group mb-3">
                  ...
                  <div
                    ...
                    <input type="text"
                      class="form-control <?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'form-control-left' : 'form-control-right' ?>"
                      name="facebook" value="<?php echo $user['facebook'] ?>" placeholder="<?php echo lang('NO DATA') ?>"
