  ...
  if (empty($formErorr)) {
    ...
    if ($is_exist_user > 0) {
      ...
      if ($_SESSION['sys']['isLicenseExpired'] == 0) {
        ...
        array_push($user_info, $company_id, $username, $hashedPass, $email, $fullname, $is_tech, $job_title_id, $gender, $address, $phone, $date_of_birth, $trust_status, base64_decode($_SESSION['sys']['UserID']), get_date_now(), $twitter, $facebook);
        // call isert function
