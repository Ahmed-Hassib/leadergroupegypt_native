    ...
    <div class="mb-3 row row-cols-sm-1 row-cols-md-2 g-3 align-items-stretch justify-content-start">
            ...
            <div class="col-6">
              <div class="card card-stat bg-danger bg-gradient">
                ...
                <div class="card-body">
                  ...
                  <a href="?do=show-malfunction-details&period=previous-month&malStatus=unrepaired"
            ...
            <div class="col-6">
              <div class="card card-stat bg-success bg-gradient">
                ...
                <div class="card-body">
                  ...
                  <a href="?do=show-malfunction-details&period=previous-month&malStatus=repaired"
                    class="stretched-link"></a>
                </div>
              </div>
            </div>
            <div class="col-6">
              <div class="card card-stat bg-warning bg-gradient">
                ...
                <div class="card-body">
                  ...
                  <a href="?do=show-malfunction-details&period=previous-month&accepted=delayed"
                    class="stretched-link"></a>
                </div>
              </div>
            </div>
      ...
      <div class="col-12">
        <div class="section-block">
          <header class="section-header">
            <h5 class="h5 text-capitalize">
              <?php echo lang("TOTAL MAL", $lang_file) ?>
            </h5>
            <p class="text-muted ">
      ...
      <div class="mb-3 row row-cols-sm-1 align-items-center-justify-content-center">
        ...
        <div class="col-12">
          <div class="section-block">
            <header class="section-header">
              <h5 class="h5 text-capitalize">
                <?php echo lang("MALS RATING", $lang_file) ?>
              </h5>
              <p class="text-muted ">
                ...
                <div class="progress">
                  <?php if ($rep_rate < 15) { ?>
                    <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $rep_rate ?>%"
                      aria-valuenow="<?php echo $rep_rate ?>" aria-valuemin="0" aria-valuemax="<?php echo $total_mal ?>">
                    </div>
                ...
                <div class="progress">
                  <?php if ($unrep_rate < 15) { ?>
                    <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $unrep_rate ?>%"
                      aria-valuenow="<?php echo $unrep_rate ?>" aria-valuemin="0" aria-valuemax="<?php echo $total_mal ?>">
                    </div>
                    <div class="progress-value">
                      <?php echo $unrep_rate ?>%
                    </div>
                ...
                <div class="progress">
                  <?php if ($del_rate < 15) { ?>
                    <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $del_rate ?>%"
                      aria-valuenow="<?php echo $del_rate ?>" aria-valuemin="0" aria-valuemax="<?php echo $total_mal ?>">
                    </div>
                    <div class="progress-value">
                      <?php echo $del_rate ?>%
                    </div>
                  ...
                  <tbody>
                    ...
                    foreach ($today_mal as $index => $mal) {
                      ...
                      <tr class="text-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
                        ...
                        <!-- address -->
                        <td style="min-width: 100px"
                          class="<?php echo empty($client_addr) ? 'text-danger fw-bold fs-12' : '' ?>">
                        ...
                        <td style="width: 100px">
                          <a
                            href="<?php echo $nav_up_level ?>users/index.php?do=edit-user-info&userid=<?php echo $mal['tech_id'] ?>">
                        ...
                        <td style="width: 50px">
                          <?php if ($_SESSION['sys']['mal_show'] == 1) { ?>
                            <a href="?do=edit-malfunction-info&malid=<?php echo base64_encode($mal['mal_id']) ?>" target=""
                          ...
                          <?php if ($_SESSION['sys']['comb_delete'] == 1) { ?>
                            <button type="button" class="btn btn-outline-danger text-capitalize form-control bg-gradient fs-12"
                              ...
                              data-mal-id="<?php echo base64_encode($mal['mal_id']) ?>"
