...
<div class="container" dir="<?php echo $page_dir ?>">
  ...
  <div class="stats">
      ...
      <div class="col-12">
        <div class="section-block">
          ...
          <div class="row row-cols-sm-2 g-3">
            <div class="col-6">
              <div class="card card-stat bg-total bg-gradient">
                <?php $total_mal = $mal_obj->count_records("`mal_id`", "`malfunctions`", "$techCondition2 " . (empty($techCondition2) ? "WHERE YEAR(`added_date`) = '{$target_year}' AND `company_id` = " . base64_decode($_SESSION['sys']['company_id']) : "AND `company_id` = " . base64_decode($_SESSION['sys']['company_id']))) ?>
                <div class="card-body">
                  <h5 class="card-title text-capitalize">
                    <?php echo lang('TOTAL', $lang_file) ?>
                  </h5>
            ...
            <div class="col-6">
              <div class="card card-stat bg-danger bg-gradient">
                <?php $total_unrep_mal = $mal_obj->count_records("`mal_id`", "`malfunctions`", "WHERE (`mal_status` = 0 AND `isAccepted` <> 2) AND YEAR(`added_date`) = '{$target_year}' AND `company_id` = " . base64_decode($_SESSION['sys']['company_id']) . " $techCondition1") ?>
                <div class="card-body">
                  <h5 class="card-title text-capitalize">
                    <?php echo lang('UNFINISHED', $lang_file) ?>
                  </h5>
            ...
            <div class="col-6">
              <div class="card card-stat bg-success bg-gradient">
                <?php $total_rep_mal = $mal_obj->count_records("`mal_id`", "`malfunctions`", "WHERE `mal_status` = 1 AND YEAR(`added_date`) = '{$target_year}' AND `company_id` = " . base64_decode($_SESSION['sys']['company_id']) . " $techCondition1") ?>
                <div class="card-body">
                  <h5 class="card-title text-capitalize">
                    <?php echo lang('FINISHED', $lang_file) ?>
                  </h5>
            ...
            <div class="col-6">
              <div class="card card-stat bg-warning bg-gradient">
                <?php $total_del_mal = $mal_obj->count_records("`mal_id`", "`malfunctions`", "WHERE (`mal_status` = 2 OR `isAccepted` = 2) AND YEAR(`added_date`) = '{$target_year}' AND `company_id` = " . base64_decode($_SESSION['sys']['company_id']) . " $techCondition1") ?>
                <div class="card-body">
                  <h5 class="card-title text-capitalize">
                    <?php echo lang('DELAYED', $lang_file) ?>
                  </h5>
          ...
          <div class="section-block">
            ...
            ?>
              <div class="table-responsive-sm">
                <table class="table table-bordered table-striped no-index display display-big-data compact table-style w-100">
    ...
    <?php $latest_mal = $mal_obj->select_specific_column("*", "`malfunctions`", "WHERE YEAR(`added_date`) = '{$target_year}' AND `company_id` = " . base64_decode($_SESSION['sys']['company_id']) . " $techCondition1 ORDER BY `added_date` DESC, `added_time` DESC LIMIT 5"); ?>
      ...
      <div class="mb-3 row">
        <div class="col-12">
          <div class="section-block">
            ...
            <div class="table-responsive-sm">
              <table class="table table-bordered table-striped no-index display display-big-data compact table-style w-100" id="latest-mal">
                <thead class="primary text-capitalize">
                  <tr>
                    <th>
                      <?php echo lang('NAME', $lang_file) ?>
