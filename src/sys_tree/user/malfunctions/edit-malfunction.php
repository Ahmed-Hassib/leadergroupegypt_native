          ...
          <div class="section-block">
            ...
            <div class="mb-sm-2 mb-md-3 row align-items-start">
              ...
              <div class="col-sm-12 col-md-8 position-relative">
                <div class="row">
                  <div class="col-4">
                    <input name="cost" id="cost" class="form-control"  placeholder="<?php echo language('MALFUNCTION COST', @$_SESSION['systemLang']) ?>" value="<?php echo $mal_info['cost'] ?>" <?php if ($_SESSION['isTech'] == 0 || $mal_info['mal_status'] == 1) {echo 'disabled';} ?> onblur="arabic_to_english_nums(this)">
                  </div>
                  <div class="mt-2 col">
