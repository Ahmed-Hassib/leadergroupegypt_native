  ...
  <div class="container" dir="<?php echo $page_dir ?>">
    ...
    <form class="custom-form" action="?do=update-malfunction-info" method="POST" enctype="multipart/form-data" id="edit-malfunction-info">
        ...
        <?php if ($_SESSION['sys']['mal_update'] == 1 || (base64_decode($_SESSION['sys']['UserID']) == $mal_info['tech_id'] && $_SESSION['sys']['isTech'] == 1)) { ?>
          <div class="<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>">
            <button type="submit" form="edit-malfunction-info" class="btn btn-primary text-capitalize form-control bg-gradient fs-12 py-1" id="update-malfunctions">
              <i class="bi bi-check-all"></i>&nbsp;<?php echo lang('SAVE') ?>
            </button>
          </div>
        <?php } ?>
      ...
      <div class="edit-mal-content" id="malfuction-body">
        ...
        <div class="edit-mal-content__subinfo">
          <div class="section-block">
            <div class="section-header">
              <h5><?php echo lang('RESP MAL', $lang_file) ?></h5>
              <hr />
            </div>
            <!-- malfunctions id -->
          ...
          <div class="section-block">
            <header class="section-header">
              <h5 class="h5"><?php echo lang("STATUS", $lang_file) ?></h5>
              <hr>
            </header>
            <!-- status -->
            <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
              <select name="mal-status" id="mal-status" class="form-select" <?php echo $_SESSION['sys']['isTech'] == 0 || $mal_info['mal_status'] == 1 ? 'disabled' : '' ?>>
                ...
                <option value="<?php echo base64_encode(0) ?>" <?php echo $mal_info['mal_status'] == 0 ? 'selected' : '' ?>><?php echo lang('UNFINISHED', $lang_file) ?></option>
                <option value="<?php echo base64_encode(1) ?>" <?php echo $mal_info['mal_status'] == 1 ? 'selected' : '' ?>><?php echo lang('FINISHED', $lang_file) ?></option>
                <option value="<?php echo base64_encode(2) ?>" <?php echo $mal_info['mal_status'] == 2 ? 'selected' : '' ?>><?php echo lang('DELAYED', $lang_file) ?></option>
              </select>
              <label for="mal-status" class="col-sm-12 col-form-label text-capitalize pt-0"><?php echo lang('STATUS', $lang_file) ?></label>
            </div>
          </div>
        </div>
        <!-- client information -->
        <div class="section-block">
          <div class="section-header">
            <h5><?php echo lang('VICTIM INFO', $lang_file) ?></h5>
            <hr />
          </div>
          ...
          <div class="victim-info-content">
            ...
            <div class="victim-info-content__row">
              ...
              <div class="col-sm-12 col-md-7 position-relative position-relative">
                ...
                <?php if ($_SESSION['sys']['pcs_show'] == 1) { ?>
                  <a class="text-primary" href="<?php echo $nav_up_level ?>pieces/index.php?do=edit-piece&piece-id=<?php echo base64_encode($mal_info['client_id']) ?>" target="_blank"><?php echo $client_details['full_name'] ?>&nbsp;<i class="bi bi-arrow-up-left-square"></i></a>
                <?php } else { ?>
            ...
            <!-- client address -->
            <div class="victim-info-content__row">
              <label for="client-addr"><?php echo lang('ADDR', $lang_file) ?></label>
              <div class="col-sm-12 col-md-7 position-relative position-relative">
            ...
            <!-- client address -->
            <div class="victim-info-content__row">
              <label for="client-addr"><?php echo lang('PHONE', $lang_file) ?></label>
              <div class="col-sm-12 col-md-7 position-relative position-relative">
            ...
            <!-- client ip -->
            <div class="victim-info-content__row">
              <label for="client-ip"><span class="text-uppercase"><?php echo lang('IP') ?></span></label>
              <div class="col-sm-12 col-md-7 position-relative position-relative">
            ...
            <!-- piece notes -->
            <div class="victim-info-content__row">
              <label for="client-notes"><span class="text-uppercase"><?php echo lang('NOTE') ?></span></label>
              <div class="col-sm-12 col-md-7 position-relative position-relative">
            ...
            <!-- piece visit-time -->
            <div class="victim-info-content__row">
              <label for="client-visit-time"><span class="text-uppercase"><?php echo lang('VISIT TIME', 'pieces') ?></span></label>
              <div class="col-sm-12 col-md-7 position-relative position-relative">
                <?php if (!empty($client_details['visit_time'] > 0)) { ?>
                  <span class="text-primary"><?php echo $client_details['visit_time'] == 1 ? lang('ANY TIME', 'pieces') : lang('ADVANCE CONNECTION', 'pieces'); ?></span>
                <?php } else { ?>
            ...
            <div class="victim-info-content__row">
              ...
              <div class="col-sm-12 col-md-7 position-relative">
                <span class="text-start" dir="<?php echo @$_SESSION['sys']['lang'] == "ar" ? "rtl" : "ltr" ?>"><?php echo $malCounter . " " . ($malCounter > 2 ? lang("MALS", $lang_file) : lang("MAL", $lang_file)) ?></span>
                <a href="?do=show-pieces-malfunctions&pieceid=<?php echo base64_encode($mal_info['client_id']) ?>" class="mt-2 text-start" dir="<?php echo @$_SESSION['sys']['lang'] == "ar" ? "rtl" : "ltr" ?>"><?php echo lang("DETAILS") ?>&nbsp;<i class="bi bi-arrow-up-left-square"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section-block">
          <div class="section-header">
            <h5><?php echo lang('MAL INFO', $lang_file) ?></h5>
            <hr />
          </div>
          <!-- description -->
          <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
            <textarea name="descreption" id="descreption" title="describe the malfunction" class="form-control w-100" style="height: 5rem; resize: none; direction: <?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'rtl' : 'ltr' ?>" placeholder="Describe the malfunction" required <?php echo $_SESSION['sys']['isTech'] == 1 || $mal_info['mal_status'] == 1 ? 'disabled' : '' ?>><?php echo $mal_info['descreption'] ?></textarea>
            <label for="descreption"><?php echo lang('MAL DESC', $lang_file) ?></label>
          </div>
          <!-- technical man comment -->
          <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
            <textarea name="comment" id="comment" class="form-control w-100" style="height: 5rem; resize: none; direction: <?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'rtl' : 'ltr' ?>" <?php echo $_SESSION['sys']['isTech'] == 0 || $mal_info['mal_status'] == 1 ? 'disabled' : '' ?>><?php echo empty($mal_info['tech_comment']) && $mal_info['mal_status'] == 1 ? "لا يوجد تعليق من الفني" : $mal_info['tech_comment']; ?></textarea>
        ...
        <div class="section-block">
          <div class="section-header">
            <h5><?php echo lang('MAL REVIEW', $lang_file) ?></h5>
            <hr />
          </div>
          <!-- quality of employee -->
          <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
            <select name="technical-qty" id="technical-qty" class="form-select" <?php echo $_SESSION['sys']['mal_review'] == 0 || ($mal_info['mal_status'] == 0 && $_SESSION['sys']['isTech'] == 0) || $mal_info['isAccepted'] == 2 || $mal_info['isReviewed'] == 1 ? 'disabled' : '' ?>>
              <option value="default" disabled <?php echo $mal_info['isReviewed'] == 0 ? "selected" : '' ?>><?php echo lang('SELECT QTY', $lang_file) ?></option>
              <option value="<?php echo base64_encode(1) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['qty_emp'] == 1 ? "selected" : '' ?>><?php echo lang('BAD') ?></option>
              <option value="<?php echo base64_encode(2) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['qty_emp'] == 2 ? "selected" : '' ?>><?php echo lang('GOOD') ?></option>
              <option value="<?php echo base64_encode(3) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['qty_emp'] == 3 ? "selected" : '' ?>><?php echo lang('VERY GOOD') ?></option>
            </select>
          ...
          <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
            <select name="service-qty" id="service-qty" class="form-select" <?php echo $_SESSION['sys']['mal_review'] == 0 || ($mal_info['mal_status'] == 0 && $_SESSION['sys']['isTech'] == 0) || $mal_info['isAccepted'] == 2 || $mal_info['isReviewed'] == 1 ? 'disabled' : '' ?>>
              <option value="default" disabled <?php echo $mal_info['isReviewed'] == 0 ? "selected" : '' ?>><?php echo lang('SELECT QTY', $lang_file) ?></option>
              <option value="<?php echo base64_encode(1) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['qty_service'] == 1 ? "selected" : '' ?>><?php echo lang('BAD') ?></option>
              <option value="<?php echo base64_encode(2) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['qty_service'] == 2 ? "selected" : '' ?>><?php echo lang('GOOD') ?></option>
              <option value="<?php echo base64_encode(3) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['qty_service'] == 3 ? "selected" : '' ?>><?php echo lang('VERY GOOD') ?></option>
            </select>
          ...
          <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
            <select name="money-review" id="money-review" class="form-select" <?php echo $_SESSION['sys']['mal_review'] == 0 || ($mal_info['mal_status'] == 0 && $_SESSION['sys']['isTech'] == 0) || $mal_info['isAccepted'] == 2 || $mal_info['isReviewed'] == 1 ? 'disabled' : '' ?>>
              <option value="default" disabled <?php echo $mal_info['isReviewed'] == 0 ? "selected" : '' ?>><?php echo lang('SELECT QTY', $lang_file) ?></option>
              <option value="<?php echo base64_encode(1) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['money_review'] == 1 ? "selected" : '' ?>><?php echo lang('RIGHT') ?></option>
              <option value="<?php echo base64_encode(2) ?>" <?php echo $mal_info['isReviewed'] == 1 && $mal_info['money_review'] == 2 ? "selected" : '' ?>><?php echo lang('WRONG') ?></option>
            </select>
            <label for="money-review"><?php echo lang('COST REVIEW', $lang_file) ?></label>
          </div>
          <!-- employee review comment -->
          <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
            <textarea name="review-comment" id="review-comment" title="review comment" class="form-control w-100" style="height: 5rem; resize: none; direction: <?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'rtl' : 'ltr' ?>" <?php echo $_SESSION['sys']['mal_review'] == 0 || ($mal_info['mal_status'] == 0 && $_SESSION['sys']['isTech'] == 0) || $mal_info['isAccepted'] == 2 || $mal_info['isReviewed'] == 1 ? 'disabled' : '' ?> placeholder="<?php echo lang('NOTE') ?>"><?php echo $mal_info['qty_comment'] ?></textarea>
          ...
          <?php if ($mal_info['isReviewed'] != 0 && $mal_info['mal_status'] == 0 && $_SESSION['sys']['isTech'] == 0) { ?>
            <div class="mb-1 row align-items-center">
              <i class="bi bi-exclamation-triangle-fill"></i>&nbsp;
              <span class="text-warning" dir="<?php echo @$_SESSION['sys']['lang'] == 0 ? 'rtl' : 'ltr' ?>" style="text-align: <?php echo @$_SESSION['sys']['lang'] == 0 ? 'right' : 'left' ?>"><?php echo lang('REVIEW ERROR', $lang_file) ?></span>
            </div>
          <?php } ?>
        </div>
