      ...
      <div class="modal-body">
        <form action="?do=update-direction-info" method="POST" id="editDirection" onchange="form_validation(this)">
          ...
          <div class="mb-sm-2 mb-md-3 row">
              ...
              <div class="col-sm-12 col-md-8">
                <input type="text" class="form-control" name="new-direction-name" id="new-direction-name" placeholder="<?php echo language('DIRECTION NAME', @$_SESSION['systemLang']) ?>" onkeyup="direction_validation(this)" required>
