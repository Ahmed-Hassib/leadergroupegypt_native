        ...
        <form action="<?php echo $sys_tree_user ?>directions/index.php?do=insert-new-direction" method="POST" id="addNewDirection" onchange="form_validation(this)">
          ...
          <div class="mb-sm-2 mb-md-3 row">
            ...
            <div class="col-sm-12 position-relative">
              <input type="text" class="form-control" name="direction-name" id="direction-name" placeholder="<?php echo language('DIRECTION NAME', @$_SESSION['systemLang']) ?>" onblur="direction_validation(this)" required>
