<!-- Modal -->
<div class="modal fade" id="deleteDirectionModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" dir="<?php echo $page_dir ?>">
  <div class="modal-dialog modal-dialog-centered modal-type-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="m-auto modal-title h5 " id="staticBackdropLabel"><?php echo lang("DELETE DIR", $lang_file) ?></h5>
      </div>
      <div class="modal-body">
        <form action="?do=delete-direction" method="POST" id="deleteDirection">
          ...
          <div class="mb-3 form-floating form-floating-<?php echo $_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?>">
            ...
            <label for="deleted-dir-name"><?php echo lang('DIRECTION', $lang_file) ?></label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger py-1 fs-12" form="deleteDirection" onclick="form_validation(this.form, 'submit')"><i class="bi bi-trash"></i>&nbsp;<?php echo lang("DELETE") ?></button>
