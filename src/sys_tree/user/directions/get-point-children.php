...
if (isset($_POST['dir_id']) && !empty($_POST['dir_id']) && isset($_POST['src_id']) && !empty($_POST['src_id'])) {
  ...
  include str_repeat("../", 4) . "classes/global/Database.class.php";
  include str_repeat("../", 4) . "classes/sys_tree/Direction.class.php";
  include str_repeat("../", 4) . "includes/functions/global/functions.php";
