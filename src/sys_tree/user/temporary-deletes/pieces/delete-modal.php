    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-capitalize " id="exampleModalLabel">
          <?php echo lang('DELETE PCS', 'pieces') ?>
        </h5>
      </div>
      <div class="modal-body">
        <h5 class="h5">
          <?php echo lang('CONFIRM DELETE') ?>&nbsp;<span class="text-danger" id="deleted-piece-name"></span>&nbsp;
      ...
      <div class="modal-footer">
        <?php if ($_SESSION['sys']['pcs_delete'] == 1 && $_SESSION['sys']['isLicenseExpired'] == 0) { ?>
          <a id="deleted-piece-url" dir="<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'ltr' : 'rtl' ?>"
