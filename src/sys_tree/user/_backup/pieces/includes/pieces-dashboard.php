                            ...
                            <tbody>
                                ...
                                <?php foreach ($latest_added_pcs as $key => $pcs) { ?>
                                    <tr>
                                        ...
                                        <!-- piece name -->
                                        <td>
                                            <a class="<?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="?name=pieces&do=edit-piece&piece-id=<?php echo $pcs['piece_id']; ?>" target="">
                                        ...
                                        <!-- control -->
                                        <td>
                                            <a class="btn btn-success text-capitalize fs-12 <?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="?name=pieces&do=edit-piece&piece-id=<?php echo $pcs['piece_id']; ?>" target=""><i class="bi bi-pencil-square"></i><!-- <?php echo language('EDIT', @$_SESSION['systemLang']) ?> --></a>
                                            <a class="btn btn-outline-primary text-capitalize fs-12 <?php if ($_SESSION['pcs_show'] == 0) {echo 'd-none';} ?>" href="?name=pieces&do=show-piece&dir-id=<?php echo $pcs['direction_id'] ?>&srcId=<?php echo $pcs['piece_id'] ?>" ><i class="bi bi-eye"></i><!-- <?php echo language('SHOW', @$_SESSION['systemLang']).' '.language('PIECES', @$_SESSION['systemLang']) ?> --></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
