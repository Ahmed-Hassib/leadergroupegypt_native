                            ...
                            <tbody>
                                ...
                                <?php foreach ($latest_added_clients as $key => $client) { ?>
                                    <tr>
                                        ...
                                        <!-- piece name -->
                                        <td>
                                            <a class="<?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="?name=clients&do=edit-piece&piece-id=<?php echo $client['piece_id']; ?>" target="">
                                        ...
                                        <!-- control -->
                                        <td>
                                            <a class="btn btn-success text-capitalize fs-12 <?php if ($_SESSION['pcs_update'] == 0) {echo 'd-none';} ?>" href="?name=clients&do=edit-piece&piece-id=<?php echo $client['piece_id']; ?>" target=""><i class="bi bi-pencil-square"></i><!-- <?php echo language('EDIT', @$_SESSION['systemLang']) ?> --></a>
                                            <?php if ($client['is_client'] == 0) { ?>
                                                <a class="btn btn-outline-primary text-capitalize fs-12 <?php if ($_SESSION['pcs_show'] == 0) {echo 'd-none';} ?>" href="?do=show-piece&dir-id=<?php echo $client['direction_id'] ?>&srcId=<?php echo $client['piece_id'] ?>" ><i class="bi bi-eye"></i><!-- <?php echo language('SHOW', @$_SESSION['systemLang']).' '.language('PIECES', @$_SESSION['systemLang']) ?> --></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
