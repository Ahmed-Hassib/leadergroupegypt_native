...
<div class="container" dir="<?php echo @$_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
    ...
    <form class="profile-form" action="?do=insertUser" method="POST" id="addUser">
        ...
        <div class="hstack gap-2">
            <!-- submit button -->
            <button type="button" form="addUser" class="btn btn-primary text-capitalize fs-12 <?php echo @$_SESSION['systemLang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>" <?php if ($_SESSION['user_add'] == 0) {echo 'disabled';} ?> onclick="form_validation(this.form, 'submit')">
