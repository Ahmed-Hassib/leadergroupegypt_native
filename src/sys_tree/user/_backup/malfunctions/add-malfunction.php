    ...
    <form class="custom-form" action="?do=insertMalfunctions" method="POST" id="addMalfunction">
        ...
        <div class="hstack gap-3">
            <div class="<?php echo @$_SESSION['systemLang'] == 'ar' ? 'me-auto' : 'ms-auto' ?>">
                <button type="button" form="addMalfunction" class="btn btn-primary text-capitalize form-control bg-gradient fs-12 <?php if ($_SESSION['mal_add'] == 0 || $emp_counter == 0 || $pcs_counter == 0) {echo 'disabled';} ?>" id="add-malfunctions" onclick="form_validation(this.form, 'submit')">
