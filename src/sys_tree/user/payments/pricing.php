          ...
          <div class="section-block">
            <div class="section-header text-center">
              ...
              <h3 class="h3 text-capitalize">
                <?php
                // get price
                $price = $country_id == 1 ? $plan['price_eg'] : $plan['price_en'];
                // get currency
                $currency = $country_id == 1 ? 'L.E' : '$';
                // period
                $period = lang('MONTH');
                ?>
            ...
            <div>
              ...
              <div class="mt-5 hstack">
                <button type="button" class="mx-auto w-100 btn btn-outline-primary" data-bs-toggle="modal"
                  data-bs-target="#paymentMethodTypeModal"
                  data-price="<?php echo $country_id == 1 ? $plan['price_eg'] : $plan['price_en'] ?>"
                  data-currency="<?php echo $country_id == 1 ? 'EGP' : 'USD' ?>"
                  data-plan="<?php echo base64_encode($plan['id']) ?>">
...
<div class="modal fade" id="paymentMethodTypeModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
  aria-labelledby="paymentMethodTypeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close btn-close-<?php echo $page_dir == 'rtl' ? 'left' : 'right' ?>"
...
// $_SESSION['flash_message'] = 'UNDER DEVELOPING';
