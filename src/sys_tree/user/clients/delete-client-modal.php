  ...
  <div class="modal-dialog modal-dialog-centered" style="width: 500px" dir="<?php echo @$_SESSION['systemLang'] == 'ar' ? 'rtl' : 'ltr' ?>">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a id="deleted-piece-url" dir="<?php echo @$_SESSION['systemLang'] == 'ar' ? 'ltr' : 'rtl' ?>" class="btn btn-danger text-capitalize fs-12 py-1 <?php if ($_SESSION['pcs_delete'] == 0) {echo 'd-none';} ?>"><i class="bi bi-trash"></i>&nbsp;<?php echo language('DELETE', @$_SESSION['systemLang']) ?></a>
