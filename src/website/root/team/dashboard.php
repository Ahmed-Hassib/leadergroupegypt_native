          ...
          <tr>
            ...
            <td class="text-center">
              <?php if ($member['is_active']) { ?>
                <a href="?do=deactivate-member&id=<?php echo base64_encode($member['id']) ?>" class="btn btn-danger py-0"><i class="bi bi-x"></i><span>
                    <?php echo lang('DEACTIVATE') ?>
                  </span></a>
              <?php } else { ?>
                <a href="?do=activate-member&id=<?php echo base64_encode($member['id']) ?>" class="btn btn-primary py-0"><i class="bi bi-check"></i><span>
                    <?php echo lang('ACTIVATE') ?>
                  </span></a>
              <?php } ?>
              <a href="?do=edit-member&id=<?php echo base64_encode($member['id']) ?>" class="btn btn-outline-success py-0"><i class="bi bi-pencil-square"></i></a>
              <button type="button" data-href="?do=delete-member&id=<?php echo base64_encode($member['id']) ?>&back=true" class="btn btn-outline-danger py-0" onclick="confirm_delete(this)"><i class="bi bi-trash"></i></button>
            </td>
          </tr>
        <?php } ?>
      <?php } ?>
