    ...
    <thead class="primary text-capitalize">
      <tr>
        ...
        <th class="text-center">
          <?php echo lang('SERVICE IMG', $lang_file) ?>
        </th>
        <th class="text-center">
          <?php echo lang('LINK 1 AR', $lang_file) ?>
        </th>
        <th class="text-center">
          <?php echo lang('LINK 1 EN', $lang_file) ?>
        </th>
        <th class="text-center">
          <?php echo lang('LINK 1', $lang_file) ?>
        </th>
        <th class="text-center">
          <?php echo lang('LINK 2 AR', $lang_file) ?>
        </th>
        <th class="text-center">
          <?php echo lang('LINK 2 EN', $lang_file) ?>
        </th>
        <th class="text-center">
          <?php echo lang('LINK 2', $lang_file) ?>
        </th>
        <th class="text-center">
      ...
      <?php if ($services_info != null && count($services_info) > 0) { ?>
        <?php foreach ($services_info as $key => $service) { ?>
          <tr>
            ...
            <td>
              <?php echo $service['link_1_ar'] ?>
            </td>
            <td>
              <?php echo $service['link_1_en'] ?>
            </td>
            <td>
            ...
            <td>
              <?php echo $service['link_2_ar'] ?>
            </td>
            <td>
              <?php echo $service['link_2_en'] ?>
            </td>
            <td>
