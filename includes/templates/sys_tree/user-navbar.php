...
<div class="sidebar-menu sidebar-menu-<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'right' : 'left' ?> close">
  ...
  <div class="sidebar-menu-brand" href="dashboard.php" <?php echo !isset($_SESSION['sys']['UserName']) ? "style='margin: auto'" : "" ?>>
    ...
    ?>
    <img src="<?php echo "$company_img_path/$company_img_name" ?>" class="sidebar-menu-logo-img" alt="<?php echo isset($_SESSION['sys']['company_name']) ? $_SESSION['sys']['company_name'] : lang('NOT ASSIGNED') ?>" id="company-img-brand">
    <!-- <img  src="<?php echo $assets ?>jsl.jpeg" > -->
    <span class="sidebar-menu-logo-name text-uppercase "><?php echo isset($_SESSION['sys']['company_name']) ? $_SESSION['sys']['company_name'] : lang('NOT ASSIGNED') ?></span>
      ...
      <li>
        ...
        <div class="icon-link">
          <section>
            ...
            <span class="link-name"><?php echo lang('EMPLOYEES') ?></span>
          </section>
          ...
          <?php if ($_SESSION['sys']['user_show'] == 1) { ?>
            <li>
              <a href="<?php echo $nav_up_level ?>users/index.php">
                <span class="link-name"><?php echo lang('LIST', 'employees') ?></span>
              </a>
            </li>
          <?php } ?>
          <?php if ($_SESSION['sys']['user_add'] == 1) { ?>
            <li>
              <a href="<?php echo $nav_up_level ?>users/index.php?do=add-new-user">
                <span class="link-name"><?php echo lang('ADD NEW', 'employees') ?></span>
              </a>
            </li>
          <?php } ?>
        </ul>
      ...
      <li>
        <div class="icon-link">
          <section>
            ...
            <span class="link-name"><?php echo lang('DIRECTIONS') ?></span>
          </section>
          <i class="bi bi-arrow-down-short"></i>
        </div>
        <!-- start sub menu -->
          ...
          <?php if ($_SESSION['sys']['dir_show'] == 1) { ?>
            <li>
              <a href="<?php echo $nav_up_level ?>directions/index.php">
                <span class="link-name"><?php echo lang('LIST', "directions") ?></span>
              </a>
            </li>
          <?php } ?>
          <?php if ($_SESSION['sys']['dir_add'] == 1) { ?>
            <li>
              <a href="#" data-bs-toggle="modal" data-bs-target="#addNewDirectionModal">
                <span class="link-name"><?php echo lang('ADD NEW', "directions") ?></span>
              </a>
            </li>
          <?php } ?>
        </ul>
      ...
      <li>
        <div class="icon-link">
          <section>
            ...
            <span class="link-name"><?php echo lang('PIECES') ?></span>
          </section>
          <i class="bi bi-arrow-down-short"></i>
        </div>
        <!-- start sub menu -->
          ...
          <?php if ($_SESSION['sys']['pcs_show'] == 1) { ?>
            ...
            <li>
              <a href="<?php echo $nav_up_level ?>pieces/index.php?do=show-all-pieces">
                <span class="link-name"><?php echo lang('LIST', 'pieces') ?></span>
              </a>
            </li>
            <li>
              <a href="<?php echo $nav_up_level ?>pieces/index.php?do=devices-companies">
                <span class="link-name"><?php echo lang('PCS TYPES', 'pieces') ?></span>
              </a>
            </li>
          <?php } ?>
          <?php if ($_SESSION['sys']['pcs_add'] == 1) { ?>
            <li>
              <a href="<?php echo $nav_up_level ?>pieces/index.php?do=add-new-piece">
                <span class="link-name"><?php echo lang('ADD NEW', 'pieces') ?></span>
              </a>
            </li>
          <?php } ?>
        </ul>
      ...
      <li>
        <div class="icon-link">
          <section>
            ...
            <span class="link-name"><?php echo lang('CONNECTION TYPES') ?></span>
          </section>
          <i class="bi bi-arrow-down-short"></i>
        </div>
        <!-- start blank sub menu -->
          ...
          <?php if ($_SESSION['sys']['connection_add'] == 1) { ?>
            <li>
              <a href="#" data-bs-toggle="modal" data-bs-target="#addNewPieceConnTypeModal">
                <span class="link-name"><?php echo lang('ADD NEW', 'pcs_conn') ?></span>
              </a>
            </li>
          <?php } ?>
          <?php
          ...
          <?php if ($_SESSION['sys']['connection_update'] == 1 && $conn_data_types > 0) { ?>
            <li>
              <a href="#" data-bs-toggle="modal" data-bs-target="#editPieceConnTypeModal">
                <span class="link-name"><?php echo lang('EDIT CONN', 'pcs_conn') ?></span>
              </a>
            </li>
          <?php } ?>
          <?php if ($_SESSION['sys']['connection_delete'] == 1 && $conn_data_types > 0) { ?>
            <li>
              <a href="#" data-bs-toggle="modal" data-bs-target="#deletePieceConnTypeModal">
                <span class="link-name"><?php echo lang('DELETE CONN', 'pcs_conn') ?></span>
              </a>
            </li>
          <?php } ?>
        </ul>
    ...
    <?php if ($_SESSION['sys']['clients_show'] == 1 || $_SESSION['sys']['clients_add'] == 1) { ?>
      ...
      <li>
        <div class="icon-link">
          <section>
            <i class="bi bi-people"></i>
            <span class="link-name"><?php echo lang('CLIENTS') ?></span>
          </section>
          <i class="bi bi-arrow-down-short"></i>
        </div>
        <!-- start sub menu -->
          ...
          <?php if ($_SESSION['sys']['clients_show'] == 1) { ?>
            ...
            <li>
              <a href="<?php echo $nav_up_level ?>clients/index.php?do=show-all-clients">
                <span class="link-name"><?php echo lang('LIST', 'clients') ?></span>
              </a>
            </li>
          <?php } ?>
          <?php if ($_SESSION['sys']['clients_add'] == 1) { ?>
            <li>
              <a href="<?php echo $nav_up_level ?>clients/index.php?do=add-new-client">
                <span class="link-name"><?php echo lang('ADD NEW', 'clients') ?></span>
              </a>
            </li>
          <?php } ?>
        </ul>
    ...
    <?php if ($_SESSION['sys']['mal_show'] == 1 || $_SESSION['sys']['mal_add'] == 1) { ?>
      ...
      <li>
        <div class="icon-link">
          <section>
            ...
            <span class="link-name"><?php echo lang('MALS') ?></span>
          </section>
          <i class="bi bi-arrow-down-short"></i>
        </div>
        <!-- start sub menu -->
          ...
          <?php if ($_SESSION['sys']['mal_add'] == 1) { ?>
            <li>
              <a href="<?php echo $nav_up_level ?>malfunctions/index.php?do=add-new-malfunction">
                <span class="link-name"><?php echo lang('ADD NEW', 'malfunctions') ?></span>
              </a>
            </li>
          <?php } ?>
        </ul>
        ...
        <li>
          <div class="icon-link">
            <section>
              ...
              <span class="link-name"><?php echo lang('COMBS') ?></span>
            </section>
            <i class="bi bi-arrow-down-short"></i>
          </div>
          <!-- start sub menu -->
            ...
            <?php if ($_SESSION['sys']['comb_add'] == 1) { ?>
              <li>
                <a href="<?php echo $nav_up_level ?>combinations/index.php?do=add-new-combination">
                  <span class="link-name"><?php echo lang('ADD NEW', 'combinations') ?></span>
                </a>
              </li>
            <?php } ?>
          </ul>
      ...
      <li>
        <a href="<?php echo $nav_up_level ?>settings/index.php">
          ...
          <span class="link-name"><?php echo lang('SETTINGS') ?></span>
        </a>
        <!-- start blank sub menu -->
        <ul class="sub-menu blank">
          <li>
      ...
      <?php if (isset($_SESSION['sys']['UserName'])) { ?>
        ...
        <li>
          ...
          <div class="profile-details">
            <a href="<?php echo $nav_up_level ?>users/index.php?do=edit-user-info&userid=<?php echo $_SESSION['sys']['UserID']; ?>">
              ...
              <div class="name-job">
                <div class="profile-name"><?php echo $_SESSION['sys']['UserName'] ?></div>
  ...
  <div class="top-navbar-content">
    ...
    <?php if (isset($_SESSION['sys']['isTrial']) && $_SESSION['sys']['isTrial'] == 1) { ?>
      <span class="<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'me-auto' : 'ms-auto' ?> mx-3">
        <span class="badge bg-danger"><?php echo lang("TRIAL") ?></span>
      </span>
    <?php } ?>
