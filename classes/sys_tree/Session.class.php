...
class Session extends Database {
  ...
  public function __construct() {
    ...
    // get company info
    $this->company_info_columns = "`companies`.`company_name`, `companies`.`company_code`, `companies`.`company_img`, `companies`.`company_port`, `companies`.`mikrotik_ip`, `companies`.`mikrotik_port`, `companies`.`mikrotik_username`, `companies`.`mikrotik_password`";
  }
